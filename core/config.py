...
class Settings(BaseSettings):
    ...
    openai_strong_model: str = "gpt-5.2"
    codex_fast_model: str = "gpt-5.5"
    codex_strong_model: str = "gpt-5.5"
    llm_provider: str = ""  # codex | openai | claude; blank = OpenAI key else Claude CLI
    ...
    equity_runner_max_runtime_seconds: int = 600
